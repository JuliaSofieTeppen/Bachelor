...
interface Template {
    ...
    * */
    ...
    /***Følgende er Template interfacet. Men hvis det trengs annerledes, så fikses det med glede.*/


    /**
     * Should sum up the Belop from each of the objects. All of these objects
     * have a variable Belop that can be accessed with the getBelop() or
     * setBelop() methods. These method will all be very similar to each other.
     *
     */
    double sumAnnet(ArrayList<Annet> list);
    ...
    /**
     * There will be difference in the mva. Some of the objects will be using
     * sats = 25% and some sats = 15% Therefore there should be two methods for
     * calculating this.
     *
     */
    double mvaHoy(ArrayList<Object> list);
    ...
    /**
     * This method should sort from newest to oldest. Sort date may need one or
     * more helper methods to be able to parse the dates. The dates are stored
     * in strings and are following "yyyy/MM/dd" format.
     *
     */
    void sortDate(ArrayList<Object> list);
